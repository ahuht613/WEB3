...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Ngày cập nhật </label>
<div class="col-sm-10">
...
{
?>
<input type="radio" name="status" value="1" required="required" checked>Hoạt động <input type="radio" name="status" value="0" required="required">Chặn 
<?php }?>
<?php  
if($stats=="0")
{
?>
<input type="radio" name="status" value="1" required="required" >Hoạt động <input type="radio" name="status" value="0" required="required" checked>Chặn 
<?php }?>
